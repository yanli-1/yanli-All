...
import com.example.finalhomework.adapter.LaunchImproveAdapter;

public class GuidePageActivity extends AppCompatActivity {
    // 声明引导页面的图片数组
    private int[] lanuchImageArray = {R.drawable.australia,
            R.drawable.nestle, R.drawable.telunsu, R.drawable.light};
